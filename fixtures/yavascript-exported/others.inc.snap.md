...
export var number: NumberConstructor;
export var string: StringConstructor;
export var boolean: BooleanConstructor;
export var bigint: BigIntConstructor;
...
# TypedArrayConstructor (exported type)
